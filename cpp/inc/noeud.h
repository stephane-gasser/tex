...
class LinkedNode : public AnyNode
{
	public:
		...
		virtual void showNode(const std::string &, std::ostream &os) { os << "Unknown node type!"; }
...
class CharNode : public LinkedNode
{
	public:
		...
		virtual void showNode(const std::string &, std::ostream &);
		virtual void vlist(scaled);
		virtual void hlist(scaled, scaled, scaled);
};
...
class NoadContent : public AnyNode
{
	public:
		...
		void subsidiarydata(char, const std::string&, std::ostream &);
